...
public class TrigramBookBuilder {
   ...
   public static void main(String args[]) {
      ...
      try {
         ...
         Report report = EngineBuilder.aNewEngine()
               ...
               .mapper(new PieTokenizer())
               .processor(new FancyProcess())
               .build().call();

         List<String> result = (List<String>) report.getBatchResult();
         String story = result.stream()
               .map(Object::toString)
               .reduce((t,u) -> t + " " + u)
               .orElse("");
   ...
   //things
   HashMap<WordPair, List<String>> pairings;

   public TrigramBookBuilder() {

   }

   public void buildPairings(String bookPath) {

   }

   public String buildNewBook(){
      return null;
   }
